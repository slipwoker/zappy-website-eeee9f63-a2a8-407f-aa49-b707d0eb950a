...
document.addEventListener('DOMContentLoaded', function() { 
  ...
  if (phoneHeaderBtn) { 
    phoneHeaderBtn.addEventListener('click', function() { 
      const phoneNumber = '+972548299093'; 
        ...
        (async function() {
          try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: 'eeee9f63-a2a8-407f-aa49-b707d0eb950a',
                name: formFields.name || formFields.fullname || formFields.full_name || '',
                email: formFields.email || '',
                subject: formFields.subject || 'Contact Form Submission',
                message: formFields.message || formFields.comments || formFields.comment || '',
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Vision Plus uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
